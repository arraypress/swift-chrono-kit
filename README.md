...
125 tests +79 (part-2: holidays and recurrence), every one a question with a single right answer that multiplication gets
...
29 February landing on the 28th, every published UK and US holiday list for 2025 and 2026,
Christmas on a Saturday in both countries, and the RFC 5545 examples with the dates the RFC
prints. Fixed dates and fixed
